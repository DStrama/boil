...
label5 = tkinter.Label(window, text=" 6 ").grid(row=1, column=4)
...
# label12 = tkinter.Label(window, text=" Koszty transportu na trasach: ").grid(row=0, column=9)
########### BARDZO GŁUPIE ALE DZIAŁA XD#######################
a = tkinter.Label(window, text="                   ").grid(row=0, column=8)
b = tkinter.Label(window, text="                   ").grid(row=0, column=8)
c = tkinter.Label(window, text="                   ").grid(row=0, column=8)
d = tkinter.Label(window, text="                   ").grid(row=0, column=8)
e = tkinter.Label(window, text="                   ").grid(row=0, column=8)
f = tkinter.Label(window, text="                   ").grid(row=0, column=8)
g = tkinter.Label(window, text="                   ").grid(row=0, column=8)
h = tkinter.Label(window, text="                   ").grid(row=0, column=8)
i = tkinter.Label(window, text="                   ").grid(row=0, column=8)
j = tkinter.Label(window, text="                   ").grid(row=0, column=8)
########### BARDZO GŁUPIE ALE DZIAŁA XD#######################
label13 = tkinter.Label(window, text=" 2->1: ").grid(row=0, column=9)
label14 = tkinter.Label(window, text=" 1->3: ").grid(row=1, column=9)
label15 = tkinter.Label(window, text=" 1->6: ").grid(row=2, column=9)
label16 = tkinter.Label(window, text=" 2->6: ").grid(row=3, column=9)
label17 = tkinter.Label(window, text=" 2->5: ").grid(row=4, column=9)
label18 = tkinter.Label(window, text=" 6->3: ").grid(row=5, column=9)
label20 = tkinter.Label(window, text=" 6->4: ").grid(row=6, column=9)
label21 = tkinter.Label(window, text=" 6->5: ").grid(row=7, column=9)
label22 = tkinter.Label(window, text=" 3->4: ").grid(row=8, column=9)
label23= tkinter.Label(window, text=" 4->5: ").grid(row=9, column=9)
kt21 = tkinter.Entry(window, width=10)
kt21.grid(row=0, column=10)
kt13 = tkinter.Entry(window, width=10)
kt13.grid(row=1, column=10)
kt16 = tkinter.Entry(window, width=10)
kt16.grid(row=2, column=10)
kt26 = tkinter.Entry(window, width=10)
kt26.grid(row=3, column=10)
kt25 = tkinter.Entry(window, width=10)
kt25.grid(row=4, column=10)
kt63 = tkinter.Entry(window, width=10)
kt63.grid(row=5, column=10)
kt64 = tkinter.Entry(window, width=10)
kt64.grid(row=6, column=10)
kt65 = tkinter.Entry(window, width=10)
kt65.grid(row=7, column=10)
kt34 = tkinter.Entry(window, width=10)
kt34.grid(row=8, column=10)
kt45 = tkinter.Entry(window, width=10)
kt45.grid(row=9, column=10)
